...
@NgModule({
  declarations: [AddCourseComponent, ManageCoursesComponent, CourseDetailsComponent, EditCourseComponent, UploadQuizComponent, EnrolledusersComponent,DeleteDialogueComponent, InstructorResultComponent, InstructorPaymentsComponent, EnrollmentChartComponent, PaymentChartComponent],
  imports: [
    CommonModule,
