...
@NgModule({
  declarations: [HomeComponent, CoursesComponent, MyCoursesComponent, CourseDetailsComponent, WatchCourseComponent, UserScoresComponent, PaymentdialogComponent, PaymentSuccessDialogComponent],
  imports: [
    CommonModule,
    UserRoutingModule,
    MatCardModule,
